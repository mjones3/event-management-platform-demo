...
@Controller
@RequestMapping("${openapi.eventManagementServiceService.base-path:/event-management-service/v1}")
public class EventManagementServiceApiController implements EventManagementServiceApi {

    private final NativeWebRequest request;

    @Autowired
    public EventManagementServiceApiController(NativeWebRequest request) {
