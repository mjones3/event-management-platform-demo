...
public class ErrorResponse {
  ...
  */
  @NotNull @Valid 
  @Schema(name = "timestamp", example = "2024-01-20T15:30:45Z", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "path", example = "/api/v1/items", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("path")
